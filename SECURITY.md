...
The supported boundary is the 0.3 loopback server under `src/gemmafischer`.
...
a mutation or study, review, or progress read, exposes a hidden study answer before the
allowed reveal, exposes arbitrary filesystem/process controls, or loads unpinned
model code, adapter, or assets.
